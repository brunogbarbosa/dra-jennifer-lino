  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <svg className="essence-thread essence-thread-desktop" viewBox="0 0 1440 740" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl`} cx="30%" cy="25%"><stop stopColor="#fff5e9"/><stop offset=".5" stopColor="#c9a780"/><stop offset="1" stopColor="#806046"/></radialGradient></defs>
      ...
      <svg className="essence-thread essence-thread-mobile" viewBox="0 0 400 900" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl-mobile`} cx="30%" cy="25%"><stop stopColor="#fff5e9"/><stop offset=".5" stopColor="#c9a780"/><stop offset="1" stopColor="#806046"/></radialGradient></defs>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src={site.images.essence} alt="Retrato da Dra. Jennifer Lino." fill sizes="(max-width:700px) 112vw, (max-width:1100px) 82vw, 67vw"/>
      </figure>
